...
struct AG85DST1UnderlyingStorageUnit{
...
int main(){
    ...
    std::deque<AG85DST1UnderlyingStorageUnit> treeUnderlyingStorage;
    ...
    std::stack<AG85DST1TraversalStackItem> treeLinksPtrsStack;
